...
@pytest.mark.vcr()
async def test_device_login(checksum_key: str, client: pssapi.PssApiClient, client_date_time: datetime.datetime, device_key: str, device_name: str, device_type: pssapi.enums.DeviceType, language_key: pssapi.enums.LanguageKey):
