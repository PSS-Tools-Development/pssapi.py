...
def test_pss_enum():
    ...
    assert _parse.pss_enum("DeviceTypeAndroid", _enums.DeviceType) == _enums.DeviceType.ANDROID
    assert _parse.pss_int(3, _enums.VisibilityFlags) == _enums.VisibilityFlags.ALWAYS_SHOW

    with _pytest.raises(TypeError):  # The enum doesn't have such a value
        _parse.pss_enum("DeviceType", _enums.DeviceType)
    with _pytest.raises(TypeError):  # The enum doesn't have such a value
        assert _parse.pss_enum("3", _enums.VisibilityFlags) == _enums.VisibilityFlags.ALWAYS_SHOW
