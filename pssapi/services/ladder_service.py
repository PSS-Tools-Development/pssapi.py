...
class LadderService(_ServiceBase, _LadderServiceRaw):
    async def list_users_by_championship_score_ranking(self, **params) -> _List[_User]:
        return await self._list_users_by_championship_score_ranking(self.production_server, self.from_, self.to, self.access_token, **params)

    async def list_users_by_ranking(self, **params) -> _List[_User]:
        return await self._list_users_by_ranking(self.production_server, self.from_, self.to, self.access_token, **params)
