...
class ResearchServiceRaw:
    ...
    async def _list_all_research_designs_2(production_server: str, language_key: str, design_version: int, **params) -> _List[_ResearchDesign]:
        ...
        result = await _core.get_entities_from_path(_ResearchDesign, 'ResearchDesigns', production_server, ResearchServiceRaw.LIST_ALL_RESEARCH_DESIGNS_2_BASE_PATH, **params)
        return result
