...
async def list_all_division_designs_2(production_server: str, design_version: int, language_key: str, **params) -> _List[_DivisionDesign]:
    ...
    content = None
    result = await _core.get_entities_from_path(_DivisionDesign, 'DivisionDesigns', production_server, LIST_ALL_DIVISION_DESIGNS_2_BASE_PATH, 'GET', request_content=content, **params)
    return result
