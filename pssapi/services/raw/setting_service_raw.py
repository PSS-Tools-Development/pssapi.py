...
async def get_latest_version_3(production_server: str, device_type: str, language_key: str, **params) -> _List[_Setting]:
    params = {
        'deviceType': device_type,
        'languageKey': language_key,
        **params
    }
    result = await _core.get_entities_from_path(_Setting, 'GetLatestSetting', production_server, GET_LATEST_VERSION_3_BASE_PATH, **params)
    return result
