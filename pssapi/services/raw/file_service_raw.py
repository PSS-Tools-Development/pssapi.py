...
async def list_files_4(production_server: str, design_version: int, language_key: str, **params) -> _List[_File]:
    ...
    content = None
    result = await _core.get_entities_from_path(_File, 'Files', production_server, LIST_FILES_4_BASE_PATH, 'GET', request_content=content, **params)
    return result
...
async def list_sprites_2(production_server: str, design_version: int, language_key: str, **params) -> _List[_Sprite]:
    ...
    content = None
    result = await _core.get_entities_from_path(_Sprite, 'Sprites', production_server, LIST_SPRITES_2_BASE_PATH, 'GET', request_content=content, **params)
    return result
