...
async def list_all_collection_designs(production_server: str, design_version: int, language_key: str, **params) -> _List[_CollectionDesign]:
    ...
    content = None
    result = await _core.get_entities_from_path(_CollectionDesign, 'CollectionDesigns', production_server, LIST_ALL_COLLECTION_DESIGNS_BASE_PATH, 'GET', request_content=content, **params)
    return result
