...
class RoomService(_ServiceBase, _RoomServiceRaw):
    async def list_action_types_2(self, **params) -> _List[_ActionType]:
        return await self._list_action_types_2(self.production_server, self.language_key, **params)

    async def list_condition_types_2(self, **params) -> _List[_ConditionType]:
        return await self._list_condition_types_2(self.production_server, self.language_key, **params)

    async def list_craft_designs(self, **params) -> _List[_CraftDesign]:
        return await self._list_craft_designs(self.production_server, **params)

    async def list_missile_designs(self, **params) -> _List[_MissileDesign]:
        return await self._list_missile_designs(self.production_server, **params)

    async def list_room_design_purchase(self, **params) -> _List[_RoomDesignPurchase]:
        return await self._list_room_design_purchase(self.production_server, **params)

    async def list_room_designs_2(self, **params) -> _List[_RoomDesign]:
        return await self._list_room_designs_2(self.production_server, self.language_key, **params)
