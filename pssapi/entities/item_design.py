...
class ItemDesign(_EntityBase, _ItemDesignRaw):
    ...
    def __init__(self, item_design_info: _EntityInfo) -> None:
        ...
        self.__item_design_flags: ItemDesignFlags = ItemDesignFlags(self.flags)
        self.__item_design_metadata: ItemDesignMetadata = ItemDesignMetadata(self.metadata)
...
class ItemDesignMetadata(dict):
    def __init__(self, metadata: str):
        ...
        self.__background_sprite_id: int = _parse.pss_int(self.__metadata.get('BackgroundSpriteId'))
        self.__destroyed_sprite_id: int = _parse.pss_int(self.__metadata.get('DestroyedSpriteId'))
        self.__idle_animation_id: int = _parse.pss_int(self.__metadata.get('IdleAnimationId'))
        self.__show_popup_only: int = _parse.pss_bool(self.__metadata.get('ShowPopupOnly'))
