...
class TaskDesignRaw:
    ...
    def __init__(self, task_design_info: _EntityInfo) -> None:
        ...
        self.global_progress: int = _parse.pss_int(
        ...
        self.task_category: str = _parse.pss_str(
            task_design_info.get('TaskCategory'))
        self.task_design_id: int = _parse.pss_int(
