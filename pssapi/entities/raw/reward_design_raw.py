...
class RewardDesignRaw:
    ...
    def __init__(self, reward_design_info: _EntityInfo) -> None:
        self.argument_string: str = _parse.pss_str(
        ...
        self.available_quantity: int = _parse.pss_int(
        ...
        self.battle_pass_tier_index: int = _parse.pss_int(
        ...
        self.max_per_user: int = _parse.pss_int(
        ...
        self.reward_description: str = _parse.pss_str(
            reward_design_info.get('RewardDescription'))
        self.reward_design_id: int = _parse.pss_int(
            reward_design_info.get('RewardDesignId'))
        self.reward_name: str = _parse.pss_str(
            reward_design_info.get('RewardName'))
        self.reward_type: str = _parse.pss_str(
