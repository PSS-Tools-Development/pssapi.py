...
class SettingRaw:
    ...
    def __init__(self, setting_info: _EntityInfo) -> None:
        ...
        self.ab_testing_start_date: _datetime = _parse.pss_datetime(setting_info.get('ABTestingStartDate'))
        ...
        self.news_update_date: _datetime = _parse.pss_datetime(setting_info.get('NewsUpdateDate'))
        ...
        self.replay_available_date: _datetime = _parse.pss_datetime(setting_info.get('ReplayAvailableDate'))
        ...
        self.support_task_ran_date: _datetime = _parse.pss_datetime(setting_info.get('SupportTaskRanDate'))
