...
class PromotionDesignRaw:
    ...
    def __init__(self, promotion_design_info: _EntityInfo) -> None:
        ...
        self.from_date: _datetime = _parse.pss__datetime(promotion_design_info.get('FromDate'))
        ...
        self.to_date: _datetime = _parse.pss__datetime(promotion_design_info.get('ToDate'))
