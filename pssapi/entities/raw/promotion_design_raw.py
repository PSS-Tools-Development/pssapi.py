...
class PromotionDesignRaw:
    ...
    def __init__(self, promotion_design_info: _EntityInfo) -> None:
        self.available_every_x_days: int = _parse.pss_int(
            promotion_design_info.get('AvailableEveryXDays'))
        self.available_for_days: int = _parse.pss_int(
        ...
        self.bonus_frame_sprite_id: int = _parse.pss_int(
            promotion_design_info.get('BonusFrameSpriteId'))
        self.button_sprite_id: int = _parse.pss_int(
            promotion_design_info.get('ButtonSpriteId'))
        self.close_button_sprite_id: int = _parse.pss_int(
        ...
        self.extra_crew_draws: int = _parse.pss_int(
        ...
        self.promotion_design_id: int = _parse.pss_int(
            promotion_design_info.get('PromotionDesignId'))
        self.promotion_type: str = _parse.pss_str(
            promotion_design_info.get('PromotionType'))
        self.purchase_mask: int = _parse.pss_int(
            promotion_design_info.get('PurchaseMask'))
        self.purchase_sprite_id: int = _parse.pss_int(
            promotion_design_info.get('PurchaseSpriteId'))
        self.remaining_quantity: int = _parse.pss_int(
            promotion_design_info.get('RemainingQuantity'))
        self.required_promotion_design_id: int = _parse.pss_int(
        ...
        self.resource_conversion_discount_percentage: int = _parse.pss_int(
            promotion_design_info.get('ResourceConversionDiscountPercentage'))
        self.reward_store_discount_percentage: int = _parse.pss_int(
