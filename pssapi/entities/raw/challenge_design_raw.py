...
class ChallengeDesignRaw:
    ...
    def __init__(self, challenge_design_info: _EntityInfo) -> None:
        self.base_prize: int = _parse.pss_int(
            challenge_design_info.get('BasePrize'))
        self.button_animation_id: int = _parse.pss_int(
            challenge_design_info.get('ButtonAnimationId'))
        self.challenge_argument: int = _parse.pss_int(
        ...
        self.challenge_design_metadata: str = _parse.pss_str(
            challenge_design_info.get('ChallengeDesignMetadata'))
        self.challenge_scoring_argument: int = _parse.pss_int(
            challenge_design_info.get('ChallengeScoringArgument'))
        self.challenge_scoring_type: str = _parse.pss_str(
            challenge_design_info.get('ChallengeScoringType'))
        self.challenge_type: str = _parse.pss_str(
        ...
        self.root_achievement_design_id: int = _parse.pss_int(
            challenge_design_info.get('RootAchievementDesignId'))
        self.special_rule_argument: int = _parse.pss_int(
            challenge_design_info.get('SpecialRuleArgument'))
        self.special_rule_type: str = _parse.pss_str(
