...
class ChallengeDesignRaw:
    ...
    def __init__(self, challenge_design_info: _EntityInfo) -> None:
        ...
        self.end_date: _datetime = _parse.pss__datetime(challenge_design_info.get('EndDate'))
        ...
        self.start_date: _datetime = _parse.pss__datetime(challenge_design_info.get('StartDate'))
