...
class StarSystemMarkerRaw:
    ...
    def __init__(self, star_system_marker_info: _EntityInfo) -> None:
        self.completion_date: _datetime = _parse.pss__datetime(star_system_marker_info.get('CompletionDate'))
        ...
        self.expiry_date: _datetime = _parse.pss__datetime(star_system_marker_info.get('ExpiryDate'))
        ...
        self.last_update_date: _datetime = _parse.pss__datetime(star_system_marker_info.get('LastUpdateDate'))
        ...
        self.star_system_arrival_date: _datetime = _parse.pss__datetime(star_system_marker_info.get('StarSystemArrivalDate'))
        ...
        self.travel_start_date: _datetime = _parse.pss__datetime(star_system_marker_info.get('TravelStartDate'))
