...
class StarSystemMarkerRaw:
    ...
    def __init__(self, star_system_marker_info: _EntityInfo) -> None:
        self.completion_date: datetime = _parse.pss_datetime(
        ...
        self.completion_remaining_value: int = _parse.pss_int(
        ...
        self.expiry_date: datetime = _parse.pss_datetime(
        ...
        self.is_collected: bool = _parse.pss_bool(
            star_system_marker_info.get('IsCollected'))
        self.is_repeatable: bool = _parse.pss_bool(
            star_system_marker_info.get('IsRepeatable'))
        self.last_update_date: datetime = _parse.pss_datetime(
        ...
        self.mission_event_id: int = _parse.pss_int(
        ...
        self.purchase_flags: int = _parse.pss_int(
        ...
        self.ship_id: int = _parse.pss_int(
        ...
        self.star_system_arrival_date: datetime = _parse.pss_datetime(
        ...
        self.star_system_marker_generator_id: str = _parse.pss_str(
            star_system_marker_info.get('StarSystemMarkerGeneratorId'))
        self.star_system_marker_id: int = _parse.pss_int(
        ...
        self.user_id: int = _parse.pss_int(
