...
class ShipDesignRaw:
    ...
    def __init__(self, ship_design_info: _EntityInfo) -> None:
        self.allow_interacial: bool = _parse.pss_bool(
            ship_design_info.get('AllowInteracial'))
        self.background_asset_id: int = _parse.pss_int(
            ship_design_info.get('BackgroundAssetId'))
        self.columns: int = _parse.pss_int(ship_design_info.get('Columns'))
        self.door_frame_left_file_id: int = _parse.pss_int(
            ship_design_info.get('DoorFrameLeftFileId'))
        self.door_frame_left_sprite_id: int = _parse.pss_int(
            ship_design_info.get('DoorFrameLeftSpriteId'))
        self.door_frame_right_file_id: int = _parse.pss_int(
            ship_design_info.get('DoorFrameRightFileId'))
        self.door_frame_right_sprite_id: int = _parse.pss_int(
        ...
        self.equipment_capacity: int = _parse.pss_int(
            ship_design_info.get('EquipmentCapacity'))
        self.exterior_file_id: int = _parse.pss_int(
            ship_design_info.get('ExteriorFileId'))
        self.exterior_sprite_id: int = _parse.pss_int(
        ...
        self.foreground_asset_id: int = _parse.pss_int(
            ship_design_info.get('ForegroundAssetId'))
        self.gas_capacity: int = _parse.pss_int(
            ship_design_info.get('GasCapacity'))
        self.hp: int = _parse.pss_int(ship_design_info.get('Hp'))
        self.interior_file_id: int = _parse.pss_int(
            ship_design_info.get('InteriorFileId'))
        self.interior_sprite_id: int = _parse.pss_int(
            ship_design_info.get('InteriorSpriteId'))
        self.lift_file_id: int = _parse.pss_int(
            ship_design_info.get('LiftFileId'))
        self.lift_sprite_id: int = _parse.pss_int(
            ship_design_info.get('LiftSpriteId'))
        self.logo_file_id: int = _parse.pss_int(
        ...
        self.required_ship_design_id: int = _parse.pss_int(
        ...
        self.thrust_line_animation_id: int = _parse.pss_int(
            ship_design_info.get('ThrustLineAnimationId'))
        self.thrust_particle_sprite_id: int = _parse.pss_int(
            ship_design_info.get('ThrustParticleSpriteId'))
        self.thrust_scale: float = _parse.pss_float(
            ship_design_info.get('ThrustScale'))
        self.unlock_cost: str = _parse.pss_str(
            ship_design_info.get('UnlockCost'))
        self.unlock_from_ship_design_id: int = _parse.pss_int(
            ship_design_info.get('UnlockFromShipDesignId'))
        self.upgrade_cost: str = _parse.pss_str(
            ship_design_info.get('UpgradeCost'))
        self.upgrade_offset_columns: int = _parse.pss_int(
            ship_design_info.get('UpgradeOffsetColumns'))
        self.upgrade_offset_rows: int = _parse.pss_int(
            ship_design_info.get('UpgradeOffsetRows'))
        self.upgrade_time: int = _parse.pss_int(
