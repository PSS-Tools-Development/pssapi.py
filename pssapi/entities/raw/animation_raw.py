...
class AnimationRaw():
    ...
    def __init__(self, animation_info: _EntityInfo) -> None:
        self.__animation_id: int = _parse.pss_int(animation_info.get('AnimationId'))
        self.__key: str = _parse.pss_str(animation_info.get('Key'))
        self.__animation_sprites: str = _parse.pss_str(animation_info.get('AnimationSprites'))
        self.__duration: int = _parse.pss_int(animation_info.get('Duration'))
        self.__animation_effect_type: str = _parse.pss_str(animation_info.get('AnimationEffectType'))
