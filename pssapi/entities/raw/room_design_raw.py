...
class RoomDesignRaw:
    ...
    def __init__(self, room_design_info: _EntityInfo) -> None:
        ...
        self.sort_index: int = _parse.pss_int(
            room_design_info.get('SortIndex'))
        self.supported_grid_types: int = _parse.pss_int(
            room_design_info.get('SupportedGridTypes'))
        self.target_type: str = _parse.pss_str(
            room_design_info.get('TargetType'))
        self.upgrade_from_room_design_id: int = _parse.pss_int(
