...
class SeasonDesignRaw:
    ...
    def __init__(self, season_design_info: _EntityInfo) -> None:
        ...
        self.end_date: _datetime = _parse.pss_datetime(season_design_info.get('EndDate'))
        self.from_date: _datetime = _parse.pss_datetime(season_design_info.get('FromDate'))
