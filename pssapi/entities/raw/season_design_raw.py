...
class SeasonDesignRaw:
    ...
    def __init__(self, season_design_info: _EntityInfo) -> None:
        ...
        self.banner_background_sprite_id: int = _parse.pss_int(
            season_design_info.get('BannerBackgroundSpriteId'))
        self.banner_sprite_id: int = _parse.pss_int(
        ...
        self.prologue_description: str = _parse.pss_str(
