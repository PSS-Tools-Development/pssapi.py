...
class MissionDesignRaw:
    ...
    def __init__(self, mission_design_info: _EntityInfo) -> None:
        ...
        self.available_from: datetime = _parse.pss_datetime(
            mission_design_info.get('AvailableFrom'))
        self.available_to: datetime = _parse.pss_datetime(
        ...
        self.condition: str = _parse.pss_str(
        ...
        self.is_single_play: bool = _parse.pss_bool(
            mission_design_info.get('IsSinglePlay'))
        self.max_attempts_per_day: int = _parse.pss_int(
            mission_design_info.get('MaxAttemptsPerDay'))
        self.max_ship_level: int = _parse.pss_int(
            mission_design_info.get('MaxShipLevel'))
        self.min_duration_since_last_event: int = _parse.pss_int(
        ...
        self.mission_description: str = _parse.pss_str(
            mission_design_info.get('MissionDescription'))
        self.mission_design_id: int = _parse.pss_int(
            mission_design_info.get('MissionDesignId'))
        self.mission_design_status: str = _parse.pss_str(
            mission_design_info.get('MissionDesignStatus'))
        self.mission_design_type: str = _parse.pss_str(
            mission_design_info.get('MissionDesignType'))
        self.mission_title: str = _parse.pss_str(
            mission_design_info.get('MissionTitle'))
        self.required_mission_design_id: int = _parse.pss_int(
        ...
        self.story_animation_id: int = _parse.pss_int(
            mission_design_info.get('StoryAnimationId'))
        self.story_description: str = _parse.pss_str(
