...
class UserRaw:
    ...
    def __init__(self, user_info: _EntityInfo) -> None:
        ...
        self.alliance_score: int = _parse.pss_int(user_info.get('AllianceScore'))
        ...
        self.challenge_wins: int = _parse.pss_int(user_info.get('ChallengeWins'))
        self.championship_score: int = _parse.pss_int(user_info.get('ChampionshipScore'))
        ...
        self.daily_challenge_win_streak: int = _parse.pss_int(user_info.get('DailyChallengeWinStreak'))
        self.daily_missions_attempted: str = _parse.pss_str(user_info.get('DailyMissionsAttempted'))
        self.daily_pvp_attacks: int = _parse.pss_int(user_info.get('DailyPVPAttacks'))
        self.daily_pv_p_defence: int = _parse.pss_int(user_info.get('DailyPvPDefence'))
        self.daily_reward_status: int = _parse.pss_int(user_info.get('DailyRewardStatus'))
        self.draws_used_today: int = _parse.pss_int(user_info.get('DrawsUsedToday'))
        ...
        self.game_center_name: str = _parse.pss_str(user_info.get('GameCenterName'))
        self.gender_type: str = _parse.pss_str(user_info.get('GenderType'))
        self.google_play_access_token_expiry_date: str = _parse.pss_str(user_info.get('GooglePlayAccessTokenExpiryDate'))
        self.google_play_id_token: str = _parse.pss_str(user_info.get('GooglePlayIdToken'))
        self.google_play_name: str = _parse.pss_str(user_info.get('GooglePlayName'))
        self.goole_play_auth_code: str = _parse.pss_str(user_info.get('GoolePlayAuthCode'))
        ...
        self.pvp_attack_draws: int = _parse.pss_int(user_info.get('PVPAttackDraws'))
        self.pvp_attack_losses: int = _parse.pss_int(user_info.get('PVPAttackLosses'))
        self.pvp_attack_wins: int = _parse.pss_int(user_info.get('PVPAttackWins'))
        self.pvp_defence_draws: int = _parse.pss_int(user_info.get('PVPDefenceDraws'))
        self.pvp_defence_losses: int = _parse.pss_int(user_info.get('PVPDefenceLosses'))
        self.pvp_defence_wins: int = _parse.pss_int(user_info.get('PVPDefenceWins'))
        self.pass_points: int = _parse.pss_int(user_info.get('PassPoints'))
        self.profile_image_url: str = _parse.pss_str(user_info.get('ProfileImageUrl'))
        self.purchase_reward_points: int = _parse.pss_int(user_info.get('PurchaseRewardPoints'))
        self.race_type: str = _parse.pss_str(user_info.get('RaceType'))
        self.ranking: int = _parse.pss_int(user_info.get('Ranking'))
        self.rewards_collectable: bool = _parse.pss_bool(user_info.get('RewardsCollectable'))
        self.ship_design_id: int = _parse.pss_int(user_info.get('ShipDesignId'))
        self.situation_occurrences: str = _parse.pss_str(user_info.get('SituationOccurrences'))
        self.situation_occurrences_today: int = _parse.pss_int(user_info.get('SituationOccurrencesToday'))
        self.status: int = _parse.pss_int(user_info.get('Status'))
        self.steam_id: str = _parse.pss_str(user_info.get('SteamId'))
        self.task_reroll_count: int = _parse.pss_int(user_info.get('TaskRerollCount'))
        ...
        self.tutorial_status: int = _parse.pss_int(user_info.get('TutorialStatus'))
        self.unlocked_character_design_ids: str = _parse.pss_str(user_info.get('UnlockedCharacterDesignIds'))
