...
class UserRaw:
    ...
    def __init__(self, user_info: _EntityInfo) -> None:
        ...
        self.__unread_message_count: str = _parse.pss_str(
        ...
        self.__credits: str = _parse.pss_str(user_info.get('Credits'))
        self.__google_play_access_token_expiry_date: str = _parse.pss_str(
        ...
        self.__situation_occurrences: str = _parse.pss_str(
        ...
        self.__nowgg_user_id: str = _parse.pss_str(
            user_info.get('NowggUserId'))
        ...
        self.__goole_play_auth_code: str = _parse.pss_str(
        ...
        self.__steam_id: str = _parse.pss_str(user_info.get('SteamId'))
        ...
        self.__daily_missions_attempted: str = _parse.pss_str(
            user_info.get('DailyMissionsAttempted'))
        self.__google_play_id_token: str = _parse.pss_str(
    ...
    def situation_occurrences(self) -> str:
        return self.__situation_occurrences
