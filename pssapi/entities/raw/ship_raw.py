...
class ShipRaw:
    ...
    def __init__(self, ship_info: _EntityInfo) -> None:
        self.brightness_value: float = _parse.pss_float(
        ...
        self.immunity_date: datetime = _parse.pss_datetime(
        ...
        self.original_race_id: int = _parse.pss_int(
            ship_info.get('OriginalRaceId'))
        self.power_score: int = _parse.pss_int(ship_info.get('PowerScore'))
        self.salvage_argument: int = _parse.pss_int(
            ship_info.get('SalvageArgument'))
        self.saturation_value: int = _parse.pss_int(
        ...
        self.skin_item_design_id: int = _parse.pss_int(
            ship_info.get('SkinItemDesignId'))
        self.standard_character_draws: int = _parse.pss_int(
