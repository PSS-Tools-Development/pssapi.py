...
class SaleRaw:
    ...
    def __init__(self, sale_info: _EntityInfo) -> None:
        ...
        self.buyer_ship_name: str = _parse.pss_str(
            sale_info.get('BuyerShipName'))
        self.character_design_id: int = _parse.pss_int(
            sale_info.get('CharacterDesignId'))
        ...
        self.currency_value: int = _parse.pss_int(
            sale_info.get('CurrencyValue'))
        self.item_design_id: int = _parse.pss_int(
            sale_info.get('ItemDesignId'))
        ...
        self.seller_ship_id: int = _parse.pss_int(
            sale_info.get('SellerShipId'))
        self.seller_ship_name: str = _parse.pss_str(
            sale_info.get('SellerShipName'))
        self.starbux_value: int = _parse.pss_int(sale_info.get('StarbuxValue'))
        self.status_date: datetime = _parse.pss_datetime(
            sale_info.get('StatusDate'))
