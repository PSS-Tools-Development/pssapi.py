...
class LiveOpsRaw:
    ...
    def __init__(self, live_ops_info: _EntityInfo) -> None:
        ...
        self.limited_catalog_expiry_date: _datetime = _parse.pss__datetime(live_ops_info.get('LimitedCatalogExpiryDate'))
        ...
        self.news_update_date: _datetime = _parse.pss__datetime(live_ops_info.get('NewsUpdateDate'))
        self.sale_argument: int = _parse.pss_int(live_ops_info.get('SaleArgument'))
        self.sale_end_date: _datetime = _parse.pss__datetime(live_ops_info.get('SaleEndDate'))
        ...
        self.sale_start_date: _datetime = _parse.pss__datetime(live_ops_info.get('SaleStartDate'))
        ...
        self.support_task_ran_date: _datetime = _parse.pss__datetime(live_ops_info.get('SupportTaskRanDate'))
