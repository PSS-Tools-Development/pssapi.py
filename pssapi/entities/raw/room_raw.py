...
class RoomRaw:
    ...
    def __init__(self, room_info: _EntityInfo) -> None:
        ...
        self.salvage_string: str = _parse.pss_str(
            room_info.get('SalvageString'))
        self.ship_id: int = _parse.pss_int(room_info.get('ShipId'))
        self.target_manufacture_string: str = _parse.pss_str(
            room_info.get('TargetManufactureString'))
        self.upgrade_room_design_id: int = _parse.pss_int(
