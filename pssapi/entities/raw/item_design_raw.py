...
class ItemDesignRaw:
    ...
    def __init__(self, item_design_info: _EntityInfo) -> None:
        ...
        self.manufacture_cost: str = _parse.pss_str(
            item_design_info.get('ManufactureCost'))
        self.market_price: int = _parse.pss_int(
        ...
        self.min_room_level: int = _parse.pss_int(
        ...
        self.reload_time: str = _parse.pss_str(
