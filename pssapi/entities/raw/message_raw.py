...
class MessageRaw:
    ...
    def __init__(self, message_info: _EntityInfo) -> None:
        self.activity_argument: str = _parse.pss_str(
            message_info.get('ActivityArgument'))
        self.activity_type: str = _parse.pss_str(
        ...
        self.border_sprite_id: str = _parse.pss_str(
        ...
        self.user_sprite_id: int = _parse.pss_int(
