...
class AllianceRaw:
    ...
    def __init__(self, alliance_info: _EntityInfo) -> None:
        self.alliance_country_code: str = _parse.pss_str(
            alliance_info.get('AllianceCountryCode'))
        self.alliance_description: str = _parse.pss_str(
            alliance_info.get('AllianceDescription'))
        self.alliance_id: int = _parse.pss_int(alliance_info.get('AllianceId'))
        self.alliance_name: str = _parse.pss_str(
            alliance_info.get('AllianceName'))
        self.alliance_ship_user_id: int = _parse.pss_int(
