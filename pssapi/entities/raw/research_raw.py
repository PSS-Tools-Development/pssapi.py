...
class ResearchRaw():
    ...
    def __init__(self, research_info: _EntityInfo) -> None:
        self.__research_id: int = _parse.pss_int(research_info.get('ResearchId'))
        self.__ship_id: int = _parse.pss_int(research_info.get('ShipId'))
        self.__research_design_id: int = _parse.pss_int(research_info.get('ResearchDesignId'))
        self.__research_state: str = _parse.pss_str(research_info.get('ResearchState'))
        self.__research_start_date: datetime = _parse.pss_datetime(research_info.get('ResearchStartDate'))
