...
class CharacterRaw:
    ...
    def __init__(self, character_info: _EntityInfo) -> None:
        self.ability_improvement: int = _parse.pss_int(
            character_info.get('AbilityImprovement'))
        self.attack_improvement: int = _parse.pss_int(
            character_info.get('AttackImprovement'))
        self.available_date: datetime = _parse.pss_datetime(
        ...
        self.character_name: str = _parse.pss_str(
            character_info.get('CharacterName'))
        self.deployment_date: str = _parse.pss_str(
            character_info.get('DeploymentDate'))
        self.engine_improvement: int = _parse.pss_int(
        ...
        self.hp_improvement: int = _parse.pss_int(
        ...
        self.owner_ship_id: int = _parse.pss_int(
            character_info.get('OwnerShipId'))
        self.pilot_improvement: int = _parse.pss_int(
            character_info.get('PilotImprovement'))
        self.repair_improvement: int = _parse.pss_int(
            character_info.get('RepairImprovement'))
        self.room_id: int = _parse.pss_int(character_info.get('RoomId'))
        self.science_improvement: int = _parse.pss_int(
