...
class ListFriendsRaw(EntityBaseRaw):
    ...
    def __init__(self, list_friends_info: _EntityInfo) -> None:
        ...
        self._friends: _List[_entities.Friend] = [_entities.Friend(child_info) for child_info in list_friends_info.pop("Friends")] if list_friends_info.get("Friends") else []
