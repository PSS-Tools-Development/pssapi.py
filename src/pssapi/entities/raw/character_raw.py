...
class CharacterRaw(EntityBaseRaw):
    ...
    def __init__(self, character_info: _EntityInfo) -> None:
        ...
        self._character_actions: _List[_entities.CharacterAction] = (
            [_entities.CharacterAction(child_info) for child_info in character_info.pop("CharacterActions")] if character_info.get("CharacterActions") else []
        )
        ...
        self._items: _List[_entities.Item] = [_entities.Item(child_info) for child_info in character_info.pop("Items")] if character_info.get("Items") else []
