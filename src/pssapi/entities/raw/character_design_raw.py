...
class CharacterDesignRaw(EntityBaseRaw):
    ...
    def __init__(self, character_design_info: _EntityInfo) -> None:
        ...
        self._character_parts: _List[_entities.CharacterPart] = (
            [_entities.CharacterPart(child_info) for child_info in character_design_info.get("CharacterParts")[0].get("CharacterPart")] if character_design_info.get("CharacterParts") else []
        )
