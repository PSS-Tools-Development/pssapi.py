...
class ShipRaw:
    ...
    def __init__(self, ship_info: _EntityInfo) -> None:
        ...
        self._characters: _List[_entities.Character] = [_entities.Character(child_info[1]) for child_info in ship_info.get('Characters').items()] if ship_info.get('Characters') else []
        ...
        self._items: _List[_entities.Item] = [_entities.Item(child_info[1]) for child_info in ship_info.get('Items').items()] if ship_info.get('Items') else []
        ...
        self._rooms: _List[_entities.Room] = [_entities.Room(child_info[1]) for child_info in ship_info.get('Rooms').items()] if ship_info.get('Rooms') else []
        ...
        self._user_star_systems: _List[_entities.UserStarSystem] = [_entities.UserStarSystem(
            child_info[1]) for child_info in ship_info.get('UserStarSystems').items()] if ship_info.get('UserStarSystems') else []
