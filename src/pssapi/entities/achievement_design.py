...
class AchievementDesign(_AchievementDesignRaw, _EntityWithIdBase):
    def __init__(self, achievement_design_info: _EntityInfo) -> None:
        ...
        self._achievement_scoring_type_enum: _enums.AchievementScoringType = _parse.pss_str_enum(self.achievement_scoring_type, _enums.AchievementScoringType)
    ...
    @property
    def achievement_scoring_type_enum(self) -> "_enums.AchievementScoringType":
        return self._achievement_scoring_type_enum
