...
__all__ = [
    ...
    DesignService.__name__,
    DivisionService.__name__,
    FileService.__name__,
    GalaxyService.__name__,
    HistoryService.__name__,
    ItemService.__name__,
    ...
    SituationService.__name__,
    TaskService.__name__,
    TrainingService.__name__,
