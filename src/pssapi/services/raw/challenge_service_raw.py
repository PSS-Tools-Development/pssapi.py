...
async def list_all_challenge_designs_2(production_server: str, client_date_time: str, design_version: int, language_key: str, **params) -> List[ChallengeDesign]:
    ...
    result = await core.get_entities_from_path(
        ((ChallengeDesign, "ChallengeDesigns", True),), "ChallengeDesigns", production_server, LIST_ALL_CHALLENGE_DESIGNS_2_BASE_PATH, "GET", response_gzipped=False, **params
    )
    return result
