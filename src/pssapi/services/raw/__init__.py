...
__all__ = [
    ...
    DesignServiceRaw.__name__,
    DivisionServiceRaw.__name__,
    FileServiceRaw.__name__,
    GalaxyServiceRaw.__name__,
    HistoryServiceRaw.__name__,
    ItemServiceRaw.__name__,
    ...
    SituationServiceRaw.__name__,
    TaskServiceRaw.__name__,
    TrainingServiceRaw.__name__,
    UserServiceRaw.__name__,
]
