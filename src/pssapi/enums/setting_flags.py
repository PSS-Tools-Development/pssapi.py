...
class SettingFlags(_IntFlag):
    ...
    ALLOW_TEST_PAYMENT_IN_PRODUCTION = 65536
    ...
    CHECK_STARBUX_SPENT_TASK = 536870912
    CHECK_IAP_PURCHASE_TASK = 1073741824
    VERIFY_BATTLE_CHECKSUM = 2147483648
    CHECK_MARKET_FILTERS = 4294967296
    SWITCH_ROOM_SKIN_INSTANTLY = 8589934592
